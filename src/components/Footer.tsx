...
const Footer = () => {
  ...
  return (
    <footer className="bg-navy-50 border-t border-yellow-100 py-10">
      <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="flex flex-col md:flex-row gap-8">
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href="mailto:support@letsthrivecoaching.co" className="text-gray-600 hover:text-navy-600 flex items-center gap-1">
        ...
        <div className="border-t border-yellow-100 mt-8 pt-8 text-center text-sm text-gray-500">
