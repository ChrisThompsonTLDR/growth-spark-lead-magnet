      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          <div className="w-full lg:w-1/2">
            <div className="relative aspect-video rounded-2xl overflow-hidden shadow-2xl shadow-growth-500/10 border-2 border-white">
              {/* Video thumbnail */}
              <div className="absolute inset-0 bg-gradient-to-br from-growth-900/80 to-growth-600/80 z-10"></div>
              ...
              <div className="absolute inset-0 flex items-center justify-center z-20">
                <div className="w-20 h-20 rounded-full bg-white flex items-center justify-center shadow-lg cursor-pointer">
                  <div className="w-0 h-0 border-t-[10px] border-t-transparent border-l-[20px] border-l-growth-600 border-b-[10px] border-b-transparent ml-1"></div>
                </div>
              </div>
          ...
          <div className="w-full lg:w-1/2">
            ...
            <ul className="space-y-3 mb-8">
              {[
                ...
                <li key={index} className="flex items-start">
                  <div className="text-growth-500 mr-3">✓</div>
                  <span>{item}</span>
                </li>
              ))}
            </ul>
            ...
            <Button 
              ...
              className="growth-btn-gradient text-white font-medium text-lg py-6 px-8 rounded-full shadow-lg shadow-growth-500/20"
            >
